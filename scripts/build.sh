...
docker tag mongo:latest $DOCKER_REGISTRY/micro_frontend_wrapper_service_registry_mongo:latest
docker tag mongo:latest $DOCKER_REGISTRY/micro_frontend_wrapper_service_registry_mongo:$BUILD_NUMBER
