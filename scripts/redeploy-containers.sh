...
docker rmi $DOCKER_REGISTRY/micro_frontend_wrapper_server_mongo:latest
...
docker rmi $DOCKER_REGISTRY/micro_frontend_wrapper_service_registry:latest
...
docker rmi $DOCKER_REGISTRY/micro_frontend_wrapper_service_registry_mongo:latest
...
docker rmi $DOCKER_REGISTRY/micro_frontend_wrapper_client:latest
